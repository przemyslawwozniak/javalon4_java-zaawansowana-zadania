package pl.sda.javalon4.threads;
...
public class MatrixRunner {
    ...
    public static long sumMatrixSingleThread(final int[][] matrix) {
    ...
    public static void singleThread(final int[][] matrix) {
    ...
    public static void multipleThreads(final int[][] matrix, final int noOfThreads) {
        int sizeX = matrix.length;
